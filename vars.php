<?PHP
  ...
  $_SESSION['egj_door_status_token_input_2_name'] = 'egj_door_status_token_2';
  $_SESSION['egj_door_status_token_input_3_name'] = 'egj_door_status_token_3';

  $_SESSION['egj_door_status_option_name'] = 'egj_door_status_status';
